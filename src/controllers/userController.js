...
export const registerEvent = async (req, res) => {
  ...
  try {
    ...
    // Assuming payment confirmation process here
    // If payment is successful, proceed with registration
    ...
    return res.status(200).json({ success: true, message: "User registered for the event successfully" });
  } catch (error) {
